            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-bone/60 italic">
                  Each addition is arranged before you arrive. Confirm when
                  you book.
                </p>
              </div>
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                          <label
                            htmlFor={item.id}
                            className="text-[#8FA9B3] text-sm cursor-pointer whitespace-nowrap"
                          >
                            Ask us to arrange
                          </label>
            ...
            <div className="sticky top-32 bg-ink-black border border-muted-gold/30 p-8 space-y-6">
              ...
              {(selectedProvisions.length > 0 ||
                selectedCelebrations.some(
                  (id) => celebrations.find((c) => c.id === id)?.price
                )) && (
              ...
              <div className="space-y-4 pt-4">
                ...
                <p className="text-xs text-bone/50 italic">
                  All prices in Australian Dollars. Excludes accommodation.
